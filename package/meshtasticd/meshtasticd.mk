...
MESHTASTICD_PLATFORMIO_CFLAGS = $(TARGET_CFLAGS)
MESHTASTICD_PLATFORMIO_CFLAGS += -I$(STAGING_DIR)/usr/include

MESHTASTICD_PLATFORMIO_CXXFLAGS = $(TARGET_CXXFLAGS)
MESHTASTICD_PLATFORMIO_CXXFLAGS += -std=c++17 -I$(STAGING_DIR)/usr/include

MESHTASTICD_PLATFORMIO_LDFLAGS = $(TARGET_LDFLAGS)
MESHTASTICD_PLATFORMIO_LDFLAGS += -L$(STAGING_DIR)/usr/lib
